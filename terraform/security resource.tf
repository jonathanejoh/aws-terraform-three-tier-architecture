...
resource "aws_security_group" "ejoh-three-tier-alb-sg-1" {
  name        = "ejoh-three-tier-alb-sg-1"
  description = "load balancer security group for web tier"
  vpc_id      = aws_vpc.ejoh-three-tier-vpc.id
  depends_on = [
    aws_vpc.ejoh-three-tier-vpc
  ]
...
resource "aws_security_group" "ejoh-three-tier-alb-sg-2" {
  name        = "ejoh-three-tier-alb-sg-2"
...
resource "aws_security_group" "ejoh-three-tier-ec2-asg-sg" {
  name        = "ejoh-three-tier-ec2-asg-sg"
...
resource "aws_security_group" "ejoh-three-tier-ec2-asg-sg-app" {
  name        = "ejoh-three-tier-ec2-asg-sg-app"
...
resource "aws_security_group" "ejoh-three-tier-db-sg" {
  name        = "ejoh-three-tier-db-sg"
